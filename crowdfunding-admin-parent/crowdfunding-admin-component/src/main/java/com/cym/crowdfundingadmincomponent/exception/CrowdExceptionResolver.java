...
public class CrowdExceptionResolver {
  ...
  public ModelAndView resolverNullException(NullPointerException exception,
  ...
  public ModelAndView resolverAdminExitsAddException(
      AdminExitsAddException exception, HttpServletRequest request, HttpServletResponse
      response) throws IOException {
  ...
  public ModelAndView resolverAdminExitsUpdateException(
      AdminExitsUpdateException exception, HttpServletRequest request, HttpServletResponse
      response) throws IOException {
    String viewName = CrowdConstant.ATTR_NAME_EXCEPTION;
    return commonResolver(viewName, exception, request, response, exception.getRespBeanEnum());
  }
  ...
  public ModelAndView resolverAdminLoginException(
      AdminLoginException exception, HttpServletRequest request, HttpServletResponse
      response) throws IOException {
    String viewName = CrowdConstant.ATTR_NAME_EXCEPTION;
  ...
  public ModelAndView resolverUnAccessAuthException(Exception exception, HttpServletRequest request,
      HttpServletResponse
          response) throws IOException {
