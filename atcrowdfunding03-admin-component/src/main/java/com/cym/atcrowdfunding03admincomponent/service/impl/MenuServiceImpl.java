...
import com.cym.atcrowdfunding03admincomponent.mapper.MenuMapper;
import com.cym.atcrowdfunding03admincomponent.pojo.Menu;
import com.cym.atcrowdfunding03admincomponent.service.MenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu>
    ...
    public int saveMenu (Menu menu) {
        //健壮性判断
        if (StringUtils.isEmpty(menu.getIcon()) || StringUtils.isEmpty(menu.getName()) || StringUtils.isEmpty(menu.getUrl())) {
