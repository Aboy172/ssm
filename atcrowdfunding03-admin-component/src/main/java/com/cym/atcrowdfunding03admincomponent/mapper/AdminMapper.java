...
* @Entity com.cym.atcrowdfunding03admincomponent.pojo.Admin
*/
@Repository
public interface AdminMapper extends BaseMapper<Admin> {
     ...
     * @return
     */
    Admin selectOneByLoginAcctAndUserPswd (@Param("loginAcct") String loginAcct,@Param("userPswd") String userPswd);
     ...
     * @return
     */
    List<Admin> selectByLoginAcctAndUserNameAndEmail (@Param("loginAcct") String loginAcct,@Param("userName") String userName,@Param("email") String email);
