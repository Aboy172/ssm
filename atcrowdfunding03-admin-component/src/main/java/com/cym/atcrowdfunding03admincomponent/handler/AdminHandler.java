...
import com.cym.atcrowdfunding04adminentity.entity.Student;
...
public class AdminHandler {
    ...
    public String test (@RequestBody List<Integer> array,HttpServletRequest request) {
        //获取当前请求类型
        boolean judgeRequest = CrowdUtils.judgeRequestType(request);
    ...
    @ResponseBody
    public RespBean test (@RequestBody Student student) {
        if (student == null) {
            return RespBean.error(RespBeanEnum.NULL_ENTITY,student);
        }
